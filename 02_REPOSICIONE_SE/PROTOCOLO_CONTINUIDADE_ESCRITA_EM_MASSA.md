...
#### LOTE 03 — PARTE IV — OS GALHOS — ATIVO
Capítulos 13–16.
...
> **REVISANDO E CONSTRUINDO: EXECUTE A ETAPA 03 — LOTE 03 — PARTE IV: OS GALHOS.** Releia primeiro `STATUS.md`, `BIBLIA_EDITORIAL_REPOSICIONE_SE.md`, `MAPA_MAE.md`, `MATRIZ_CAPITULOS_FUNCOES.md`, `MICROARQUITETURA_28_CAPITULOS.md`, `DICIONARIO_CANONICO_DO_METODO.md`, `LEIS_DO_POSICIONAMENTO.md`, `MAPA_STORYTELLINGS.md`, `MAPA_EXERCICIOS_TESTES.md`, `REGISTRO_DE_ALEGACOES_E_FONTES.md`, `PENDENCIAS_AUTORA.md`, `PROTOCOLO_CONTINUIDADE_ESCRITA_EM_MASSA.md` e todo o manuscrito canônico já escrito, especialmente a Parte III recém-fechada. Escreva integralmente os Capítulos 13 a 16 — `O Mapa dos Galhos`, `Amor, Família e Vínculos`, `Trabalho, Dinheiro, Carreira e Marca Pessoal` e `Fé, Corpo, Redes, Vida Pública e Política` — como prosa canônica de alta qualidade. Demonstre que a mesma pessoa pode sustentar posições diferentes em Galhos diferentes sem transformar desempenho contextual em identidade total; ensine transferência consciente de recursos entre Galhos; em Amor/Família diferencie vínculo, fusão, reciprocidade, dependência, honra, acesso, permanência, proteção e controle e semeie `Abrace o Desconforto` sem romanticizar sofrimento; em Trabalho/Dinheiro/Carreira/Marca faça a segunda leitura do Letreiro de Neon, separe valor humano, valor comunicado, preço profissional, dever, favor e exploração, desenvolva negociação e faça nascer `Pense a Longo Prazo`; se não houver episódio autobiográfico de trabalho confirmado, use caso composto/hipotético e não invente fatos; em Fé/Corpo/Redes/Vida Pública/Política aplique a mesma régua de simetria a aliados e adversários, preserve fé como lente autoral sem terceirização da consciência, trate corpo como Galho e não tribunal, ambiente digital como influência e não controle mental, faça nascer `Filtre Suas Influências` e `Resista à Manada` sem propaganda partidária. Incorpore `Mapa dos Galhos`, `Auditoria de Vínculo`, `Matriz Valor × Preço × Dever × Favor` e `Mini-Filtro de Influência` conforme o mapa de exercícios. Use Lia apenas quando demonstrar transferência de recurso e aplicação real do método. Preserve a fronteira com `Morte em Vida` e mantenha Fuga Identitária apenas como pergunta/semente para o Livro 3. Salve tudo em `MANUSCRITO/04_PARTE_IV/`, revise a Parte inteira como arco único e termine preparando inevitavelmente `PARTE V — PRAGAS, INFLUÊNCIAS E JAULAS`. Atualize `MANUSCRITO/README.md`, `STATUS.md`, `HISTORICO_ETAPAS.md` e `REGISTRO_DE_ALEGACOES_E_FONTES.md` quando aplicável, crie snapshot imutável do LOTE 03 em `ETAPAS/` e, ao concluir, entregue o **comando exato do LOTE 04**.
