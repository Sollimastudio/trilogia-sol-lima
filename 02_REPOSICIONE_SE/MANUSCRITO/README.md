# MANUSCRITO CANÔNICO — REPOSICIONE-SE

Esta pasta contém a prosa viva e canônica do Livro 2.

## Regra de precedência
1. `../BIBLIA_EDITORIAL_REPOSICIONE_SE.md`
2. `../MAPA_MAE.md`
3. `../MATRIZ_CAPITULOS_FUNCOES.md`
4. `../MICROARQUITETURA_28_CAPITULOS.md`
5. `../DICIONARIO_CANONICO_DO_METODO.md`
6. `../LEIS_DO_POSICIONAMENTO.md`
7. `../PROTOCOLO_CONTINUIDADE_ESCRITA_EM_MASSA.md`
8. estes arquivos de manuscrito.
